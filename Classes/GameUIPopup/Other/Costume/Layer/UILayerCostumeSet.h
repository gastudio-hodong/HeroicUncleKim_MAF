...
#ifndef UILayerCostumeSet_h
#define UILayerCostumeSet_h

#include "GameUIPopup/Other/Costume/Layer/UILayerCostumeParent.h"

class InfoCostume;
class UILayerCostumeSet : public UILayerCostumeParent, cocos2d::extension::TableViewDataSource, public cocos2d::extension::TableViewDelegate
{
private:
...
public:
    static UILayerCostumeSet* create(std::string strType, cocos2d::Size size);
    
    UILayerCostumeSet(void);
    virtual ~UILayerCostumeSet(void);
