//
//  PopupEventSunfishFoodResult.cpp
//  FantasyClicker-mobile
//
//  Created by MAF_Mac on 09/01/2020.
//

#include "PopupEventSunfishFoodResult.h"
...
PopupEventSunfishFoodResult::PopupEventSunfishFoodResult(void) :
_bInitUI(false),
...
bool PopupEventSunfishFoodResult::init()
{
    if ( !PopupBase::init() )
    {
        return false;
...
void PopupEventSunfishFoodResult::onEnter()
{
    PopupBase::onEnter();
...
#pragma mark - init
void PopupEventSunfishFoodResult::initVar()
{
    
}

void PopupEventSunfishFoodResult::initUi()
{
    // size
    ...
    uiClose->addClickEventListener(CC_CALLBACK_1(PopupEventSunfishFoodResult::onClickClose, this));
    _spriteContainer->addChild(uiClose);
}

#pragma mark - ui
void PopupEventSunfishFoodResult::uiContainer()
{
...
void PopupEventSunfishFoodResult::uiInfo()
{
...
void PopupEventSunfishFoodResult::uiButtons()
{
    ...
    layout->addChild(uiButtons);
    {
        ...
        uiOk->addClickEventListener(CC_CALLBACK_1(PopupEventSunfishFoodResult::onClickClose, this));
...
#pragma mark - ui : draw
void PopupEventSunfishFoodResult::drawInfo()
{
    auto layout = _uiContentsInfo;
    ...
    {
        std::string desc = objSunfishFood->getDieText();
...
void PopupEventSunfishFoodResult::drawButtons()
{
    auto layout = _uiContentsButton;
...
void PopupEventSunfishFoodResult::onClickClose(Ref* sender)
{
    //
    if ( _bResult == true )
    { // 생존
...
#pragma mark - set, get
void PopupEventSunfishFoodResult::setFoodIdx(int idx)
{
    _foodIdx = idx;
...
void PopupEventSunfishFoodResult::setLevelIdx(int idx)
{
    _levelIdx = idx;
...
void PopupEventSunfishFoodResult::setResult(bool bResult)
{
    _bResult = bResult;
